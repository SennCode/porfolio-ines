...
const Collection3 = () => {
  ...
  return (
    <div className="bg-black min-h-screen justify-center pb-20">
      ...
      <div>
        <h1 className="text-white text-4xl text-center sm:text-6xl lg:text-7xl p-10 mx-10 sm:mx-20 lg:mx-30 xl:mx-60 2xl:mx-96 slide-in-blurred-bottom">
          Collection 3
        </h1>
      </div>
          ...
          <div className="-m-1 flex flex-wrap md:-m-2">
            <div className="flex w-1/2 flex-wrap">
              <div className="w-1/2 p-1 md:p-2 ">
                <img
                  alt="gallery"
                  className="block h-full w-full rounded-lg object-cover object-center hover:animate-pulse animate-once animate-duration-[5000ms] animate-ease-linear animate-normal"
                  src={foto2}
                />
              </div>
              <div className="w-1/2 p-1 md:p-2">
