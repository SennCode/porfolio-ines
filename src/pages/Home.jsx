        ...
        >
          {isMobile ? (
            textIam === "Work" ? (
              <NavLink to="/work">
                <h1
                  className="animate-fade-up animate-once animate-duration-1500 animate-delay-10000 animate-ease-in font-bold text-7xl sm:text-7xl md:text-9xl lg:text-9xl xl:text-9xl 
        transition-transform transform-gpu "
